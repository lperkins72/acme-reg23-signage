...
This folder is the region-default content layer for `reg23`.
...
- `regions/reg23/data/primary-assets.json`
- `regions/reg23/data/primary.json`
- `regions/reg23/data/footer.json`
- `regions/reg23/data/primaryending.json`
- `regions/reg23/assets/primary/manifest.json`
- `regions/reg23/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg23`.
